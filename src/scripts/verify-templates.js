...
const HTML_DIRS = [
  { html: 'src/html/pages', templates: 'src/js/templates/pages', suffix: '-template.js' },
  { html: 'src/html/components', templates: 'src/js/templates/components', suffix: '-template.js' }
];
